...
wb = openpyxl.load_workbook('../Automate_the_Boring_Stuff_3e_onlinematerials/censuspopdata.xlsx')
sheet = wb['Population by Census Tract']
county_data = {}

# Fill in the county_data with each county's population and tracts.
print('Reading rows...')
